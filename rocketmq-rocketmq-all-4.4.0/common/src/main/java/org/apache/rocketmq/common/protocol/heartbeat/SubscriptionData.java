...
public class SubscriptionData implements Comparable<SubscriptionData> {
    ...
    private boolean classFilterMode = false;//默认类过滤模式关闭
    private String topic;
    private String subString;
    private Set<String> tagsSet = new HashSet<String>();//客户端要过滤的tag集合
    private Set<Integer> codeSet = new HashSet<Integer>();//服务端要过滤的tag hashcode 集合
    private long subVersion = System.currentTimeMillis();
    private String expressionType = ExpressionType.TAG;//默认的表达式过滤类型为tag
