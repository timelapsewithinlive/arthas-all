...
/**
 * Wildcard matcher utils
 * @author ralf0131 2017-01-06 13:17.
 * @author gongdewei 3/26/19 10:45 AM
 */
public class WildcardMatcherUtils {
     ...
     */
    public static boolean match(String target, String pattern, int stringStartNdx, int patternStartNdx) {
        //#135
